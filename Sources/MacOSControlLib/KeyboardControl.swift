...
public class KeyboardControl {
    ...
    public static func typeText(text: String) async throws {
    ...
    public static func pressKeys(keys: [Any]) async throws {
    ...
    public static func keyDown(key: String) throws {
    ...
    public static func keyUp(key: String) throws {
        guard let keyCode = getKeyCode(for: key) else {
            throw NSError(domain: "KeyboardControl", code: 1, userInfo: [NSLocalizedDescriptionKey: "Invalid key: \(key)"])
        }
