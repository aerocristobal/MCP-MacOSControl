...
public actor CoreMLManager {
    ...
    public func listAvailableModels(directory: String? = nil) throws -> [[String: Any]] {
    ...
    public func loadModel(name: String, path: String) throws -> String {
    ...
    public func unloadModel(name: String) throws {
    ...
    /// Get model metadata
    public func getModelMetadata(name: String) throws -> [String: Any] {
    ...
    public static func summarizeText(text: String, maxLength: Int = 200) -> String {
    ...
    public static func extractKeyInfo(ocrResults: [[Any]]) -> [String: Any] {
        var allText = ""
    ...
    public static func intelligentScreenAnalysis(
