...
class VisionAnalyzer {
    ...
    static func classifyImage(imageData: Data, topK: Int = 5) async throws -> [[String: Any]] {
    ...
    static func detectObjects(imageData: Data, minimumConfidence: Float = 0.5) async throws -> [[String: Any]] {
        guard let cgImage = createCGImage(from: imageData) else {
    ...
    static func detectObjects(cgImage: CGImage, minimumConfidence: Float = 0.5) async throws -> [[String: Any]] {
    ...
    static func detectRectangles(imageData: Data, minimumConfidence: Float = 0.5) async throws -> [[String: Any]] {
        guard let cgImage = createCGImage(from: imageData) else {
    ...
    static func detectRectangles(cgImage: CGImage, minimumConfidence: Float = 0.5) async throws -> [[String: Any]] {
        let imageSize = CGSize(width: cgImage.width, height: cgImage.height)
    ...
    static func detectSaliency(imageData: Data) async throws -> [String: Any] {
        guard let cgImage = createCGImage(from: imageData) else {
    ...
    static func detectSaliency(cgImage: CGImage) async throws -> [String: Any] {
        let imageSize = CGSize(width: cgImage.width, height: cgImage.height)
    ...
    static func detectFaces(imageData: Data) async throws -> [[String: Any]] {
        guard let cgImage = createCGImage(from: imageData) else {
    ...
    static func detectFaces(cgImage: CGImage) async throws -> [[String: Any]] {
        let imageSize = CGSize(width: cgImage.width, height: cgImage.height)
