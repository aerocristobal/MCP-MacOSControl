...
final class ToolRegistrationTests: XCTestCase {
    ...
    func testAccessibilityModuleHas5Tools() {
    ...
    func testWaitForUIEventModuleHas1Tool() {
    ...
    func testAllModulesToolNamesMatchExpected() {
        let expected: Set<String> = [
            ...
            "accessibility_tree", "click_element", "perform_ax_action", "element_at_position", "find_elements",
            ...
            "smart_interact",
            "verify_audit_chain", "force_rotate_unacked"
        ]
